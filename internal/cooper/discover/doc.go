...
// release asset, substitutes ${VERSION}/${ARCH} into doc 2, materializes
// aux files, and computes build_inputs_hash. Per-package failures
// surface as result:"error" entries — they do not abort the run.
package discover
